...
#-------------------------------------------------------------------------------
#split
#toma un vector u otros objetos y los divide en grupos determinado por factores
#función auxiliar en conjunto con lapply, sapply
str(split)
#X es el vector o lista del data frame
#f es un factor o lista de factores 
#drop indica si niveles de factores 
x<-c(rnorm(10),runif(10),rnorm(10,1))
f<-gl(3,10)
split(x,f)#siempre devuelve una lista

lapply(split(x,f),mean)

#Hallar la media de la T por mes
library(datasets)
head(airquality)
